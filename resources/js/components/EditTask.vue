        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="editTask" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="priority" v-model="task.priority" class="form-select">
                                    <option v-for="prios in priorities" :key="prios.code" :value="prios.code" :selected="prios.code == task.priority">{{ prios.text }}</option>
                                </select>
                            </div>
...
export default {
    ...
    methods: {
        editTask() {
            ...
            axios.put(`/api/task/${this.$route.params.id}`, data,
            {
                headers: {
        ...
        getTaskData() {
            axios.get(`/api/task/${this.$route.params.id}`, {
                ...
                this.task.priority = data.priority.priority_num;
                this.task.tags = data.tags.toString();
            }).catch((error) => {
